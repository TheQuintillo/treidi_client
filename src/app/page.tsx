...
function Index() {
  ...
  const [setUserRegister, setSetUserRegister] = useState(null);
            ...
            <div className="flex justify-center items-center  pt-12 pb-12">
              <div className="flex flex-col w-1/3">
                ...
                <p className="w-2/3 mt-3">
                  Treidi es la nueva plataforma digital para poder intercambiar
                  y adquirir productos entre particulares de manera fácil y
                  rápida
                </p>
                <Comenzar />
              </div>
